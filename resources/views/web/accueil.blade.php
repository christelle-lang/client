  ...
  <div class="row">
    <div class="col">
     ...
     <div class="col-sm-6 col-lg-3 mix ui">
       ...
       <div class="parts-top">
       <a href="{{route('shop_page')}}"><img src="assets/img/camion1.jpg" alt="Parts"> </a>
       </div>
       <h3>Sémi-remorque</h3>
       <span>12 kg</span>
       <div class="cmn-btn">
  ...
  <div class="row">
    <div class="col">
     ...
     <div class="col-sm-6 col-lg-3 mix ui">
       <div class="parts-item">
       <div class="parts-top">
        <a href="{{route('shop_page')}}"><a href="{{route('shop_page')}}"><img src="assets/img/camion1.jpg" alt="Parts"></a>
       </div>
       <h3>Sémi-remorque</h3>
       <span>12 kg</span>
       <div class="cmn-btn">
    ...
    <div class="row">
      <div class="col">
       ...
       <div class="col-sm-6 col-lg-3 mix ui">
         ...
         <div class="parts-item">
         <div class="parts-top">
          <a href="{{route('shop_page')}}"><img src="{{asset('assets/img/camion1.jpg')}}" alt="Parts"></a>
         </div>
         <h3>Sémi-remorque</h3>
         <span>12 kg</span>
         <div class="cmn-btn">
