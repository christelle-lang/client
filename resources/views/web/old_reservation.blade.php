                        ...
                        <div class="card text-center">
                            <div class="card-header">
                              <ul class="nav nav-tabs card-header-tabs">
                                <li class="nav-item">
                                  <a class="nav-link " style="color:black" aria-current="true" href="{{route('reservation_view')}}">Nouvelles réservations</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link active" href="{{route('old_reservation_view')}}" style="color:black">Anciennes réservations</a>
                                </li>
                             
                              </ul>
                            </div>
                            <div class="card-body">
                               <h4 style="color:#fdb819">  Pas d'anciennes réservations </h4>
                                      </div>
                            </div>
                          </div>
