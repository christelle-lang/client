...
<div class="container d-flex align-items-center justify-content-center">
  <div class="form-container" style="width: 75%;">
    ...
    <div class="invalid-feedback">
      ...
      <select id="typeMarchandise" name="typeMarchandise" class="form-select regionForm form-select-lg mb-3 @error('typeMarchandise') is-invalid @enderror"  value="{{session('form_data')['typeMarchandise']}}"  aria-label=".form-select-lg example" required>
