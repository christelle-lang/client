            ...
            <div class="card">
                <div class="card-body">
                    <div class="card text-center">
                        <div class="card-header ">
                          <h3 class="card-title display-0">Vos réservations</h3>
                        </div>
                        <div class="card text-center">
                            <div class="card-header">
                              <ul class="nav nav-tabs card-header-tabs">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="true" href="{{route('reservation_view')}}">Nouvelles réservations</a>
                                  </li>
                                  <li class="nav-item">
                                    <a class="nav-link" href="{{route('old_reservation_view')}}" style="color:black">Anciennes réservations</a>
                                  </li>
                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-center mt-3">
                                    <div class="card mb-3" style="max-width: 900px;">
                                        <div class="row g-0">
                                          <div class="col-md-4">
                                            <img src="assets/img/camion1.jpg" class="img-fluid rounded-start" alt="...">
                                          </div>
                                          <div class="col-md-8">
                                            <div class="card-body">
                                              <h4 class="card-title">Sémi remorque</h4>
                                              <p class="card-text" style="font-size: 22px">12kg</p>
                                              <a href="#" class="btn btn-primary">En cours</a>
                                              <div class="d-flex justify-content-around text" style="width: 180px;">
                                              <span> <a href="#"> Supprimer </a></span>
                                              <span> <a href="#"> Détatil </a></span>
                                            </div>
                                            </div>
                                          </div>
                                        </div>
