...
<input type="text" class="form-control" placeholder="email ou numéro de téléphone" >
</div>

<div class="form-group mb-2">
<input type="password" class="form-control" placeholder="Mot de passe" id="exampleCheck1" >
</div>
